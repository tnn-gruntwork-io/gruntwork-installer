...
gruntwork-install --module-name "ecs-scripts" --repo "https://github.com/tnn-gruntwork-io/terraform-aws-ecs" --branch "v0.0.1"

echo "Using gruntwork-install to install a module from the terraform-aws-ecs repo with --download-dir option"
gruntwork-install --module-name "ecs-scripts" --repo "https://github.com/tnn-gruntwork-io/terraform-aws-ecs" --branch "v0.0.1" --download-dir ~/tmp
...
gruntwork-install --module-name "dummy-module" --repo "https://github.com/tnn-gruntwork-io/gruntwork-installer" --tag "v0.0.25" --module-param "file-to-cat=$SCRIPT_DIR/integration-test.sh"

echo "Using gruntwork-install to install a module from the gruntwork-install repo with branch as ref"
gruntwork-install --module-name "dummy-module" --repo "https://github.com/tnn-gruntwork-io/gruntwork-installer" --ref "for-testing-dont-delete" --module-param "file-to-cat=$SCRIPT_DIR/integration-test.sh"

echo "Using gruntwork-install to install a module from the gruntwork-install repo with tag as ref"
gruntwork-install --module-name "dummy-module" --repo "https://github.com/tnn-gruntwork-io/gruntwork-installer" --ref "v0.0.25" --module-param "file-to-cat=$SCRIPT_DIR/integration-test.sh"
...
gruntwork-install --module-name "args-test" --repo "https://github.com/tnn-gruntwork-io/gruntwork-installer" --tag "v0.0.25" --module-param 'test-args=1 2 3 *'
...
if gruntwork-install --binary-name "gruntkms" --repo "https://github.com/tnn-gruntwork-io/gruntkms" --tag "v0.0.1" ; then
  echo "ERROR: was able to access private repo"
  exit 1
fi

echo "Verifying public repo access is allowed"
gruntwork-install --repo 'https://github.com/tnn-gruntwork-io/terragrunt' --binary-name terragrunt --tag '~>v0.21.0'
